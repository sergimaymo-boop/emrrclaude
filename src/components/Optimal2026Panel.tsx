...
// ── Palette ────────────────────────────────────────────────────────────────────
// Exportada: PortfolioCard.tsx (Cartera IBK, extraída a su propia tarjeta en la
// reordenación de módulos) reutiliza la MISMA paleta — nunca una copia que pueda
// desincronizarse visualmente del resto de OPTIMAL SUPREME.
export const ACCENT = "#f59e0b";
export const ACCENT_GLOW = "rgba(245,158,11,0.15)";
export const ACCENT_BORDER = "rgba(245,158,11,0.25)";
...
export function ActionBadge({ action }: { action: ActionRec }) {
