/**
 * RALLY-TEST ENGINE — COPIA DE LABORATORIO de rallyScoreEngine.js (18-ago-2026).
 *
 * ⚠ NO ES EL MOTOR DE PRODUCCIÓN. Rally Leaders sigue usando rallyScoreEngine.js
 * y NO debe verse afectado por nada de este archivo (mandato de Sergi 18-ago-2026:
 * "el módulo de Rally Leaders no lo toques para nada, ya está bien").
 *
 * Este archivo es el sitio donde SÍ se puede experimentar: cambiar la señal, los
 * pesos, los stops, añadir filtros de régimen, etc. Al crearse es byte-idéntico al
 * motor de producción salvo esta cabecera, para que cualquier diferencia futura de
 * resultados entre Rally Leaders y Rally-Test venga SOLO de los cambios que se
 * introduzcan aquí a propósito.
 *
 * Regla: ningún cambio probado aquí pasa a producción sin superar los gates
 * pre-registrados documentados en CLAUDE.md §10c.
 *
 * ── Cabecera original del motor copiado ──────────────────────────────────────
